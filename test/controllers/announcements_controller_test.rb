...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { cohort_id: @announcement.cohort_id, date: @announcement.date, location: @announcement.location, title: @announcement.title } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { cohort_id: @announcement.cohort_id, date: @announcement.date, location: @announcement.location, title: @announcement.title } }
