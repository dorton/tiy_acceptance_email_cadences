...
class CohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post cohorts_url, params: { cohort: { start_date: @cohort.start_date, user_id: @cohort.user_id } }
    end
  ...
  test "should update cohort" do
    patch cohort_url(@cohort), params: { cohort: { start_date: @cohort.start_date, user_id: @cohort.user_id } }
